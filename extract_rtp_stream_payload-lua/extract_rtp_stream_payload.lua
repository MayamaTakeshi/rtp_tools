...
local SILENCE_PAYLOAD_SIZE_OPUS = 80
...
local function prepare_silence() 
	...
	t = {0xd8, 0x20, 0xa2, 0xe1, 0x5a, 0x50, 0x00, 0x49, 0x24, 0x92, 0x49, 0x24, 0x50, 0x00, 0x49, 0x24, 0x92, 0x49, 0x24, 0x50, 0x00, 0x49, 0x24, 0x92, 0x49, 0x24, 0x50, 0x00, 0x49, 0x24, 0x92, 0x49, 0x24} -- copied from wireshark capture when there was silence in a call 
	...
	silence_opus = string.char(unpack(t))
end
